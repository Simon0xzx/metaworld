...
test_cases_latest_nonoise = [
    ...
    ['handle-pull-v2', SawyerHandlePullV2Policy(), .0, 1.],
    ['handle-pull-side-v1', SawyerHandlePullSideV1Policy(), .0, .92],
    ['handle-pull-side-v2', SawyerHandlePullSideV2Policy(), .0, .92],
...
test_cases_latest_noisy = [
    ...
    ['handle-pull-v2', SawyerHandlePullV2Policy(), .1, 1.],
    ['handle-pull-side-v1', SawyerHandlePullSideV1Policy(), .1, .75],
    ['handle-pull-side-v2', SawyerHandlePullSideV2Policy(), .1, .75],
